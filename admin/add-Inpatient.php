<?php 
  ...
  if (isset($_GET["add"]))
    {
        $sql1 = "SELECT * FROM id_value_patient ORDER BY ID DESC LIMIT 1";
        ...
        $fee = $_GET["fee"];
        $room = $_GET["room"];
        $diagnois = $_GET["diagnois"];
        
        $sql = "INSERT INTO inpatient (ID, `type`, First_name, Last_name, DoB, Gender, `Address`, Phone_number, Fee, Sickroom, Date_of_admission, Date_of_discharge, Diagnois, `status`)
                VALUES ('$id', 'IP', '$fname', '$lname', '$dob', '$gender', '$address', '$phone', '$fee', '$room', '$doa', '$dod', '$diagnois', 'unrecovery')";
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="doa" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="diagnois" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
